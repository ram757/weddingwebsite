...
export default class PittsburghPage extends React.PureComponent {
  ...
  render() {
    return (
      <div className="pittsburgh-page">
        ...
        <Typography variant="h1">Go Explore!</Typography>
        <Typography variant="h2">
          Get the most out of your Pittsburgh trip by hearing what Cyndaquil
          Says!
          <br />
          <br />
        </Typography>
        <MobileDisclaimer text="On mobile devices, please click on the map markers to show hover-over content.  If content does not display, Ryan probably did not test with your specific mobile browser." />
        <div
          style={{
            height: isMobileDevice() ? '70vh' : '125vh',
            paddingLeft: '5%',
            paddingRight: '5%',
          }}
        >
          ...
          >
            {PGH_LOCATIONS.map((pghItem) => (
              <MapMarker key={generateHash(10)} {...pghItem} />
            ))}
          </GoogleMap>
        </div>
        <div className="stretch-container-16">
          <img
            src={PittsburghBanner}
            alt="CMU & Pitt banner"
